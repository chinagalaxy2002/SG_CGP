...
CHECKPOINT="${CHECKPOINT:-$REPO_ROOT/checkpoints/baseline_pretrain_epoch018_weights.pt}"
TARGET_GPU="${TARGET_GPU:-0}"
TASK_NAME="${TASK_NAME:-sg_detr_dq_cgp_ft_identity_span_safe}"
...
echo "Starting identity-start, span-safe DQ-CGP fine-tuning"
echo "GPU: $TARGET_GPU"
